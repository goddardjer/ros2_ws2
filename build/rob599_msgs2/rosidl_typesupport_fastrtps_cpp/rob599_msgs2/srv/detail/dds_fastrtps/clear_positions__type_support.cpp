...
#include "rob599_msgs2/srv/detail/clear_positions__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rob599_msgs2::srv::ClearPositions_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rob599_msgs2::srv::ClearPositions_Request & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rob599_msgs2::srv::ClearPositions_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rob599_msgs2::srv::ClearPositions_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rob599_msgs2::srv::ClearPositions_Request *>(
    untyped_ros_message);
...
{
  return &rob599_msgs2::srv::typesupport_fastrtps_cpp::_ClearPositions_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rob599_msgs2, srv, ClearPositions_Request)() {
  return &rob599_msgs2::srv::typesupport_fastrtps_cpp::_ClearPositions_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rob599_msgs2
cdr_serialize(
  const rob599_msgs2::srv::ClearPositions_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rob599_msgs2::srv::ClearPositions_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = rob599_msgs2::srv::ClearPositions_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rob599_msgs2::srv::ClearPositions_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<rob599_msgs2::srv::ClearPositions_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &rob599_msgs2::srv::typesupport_fastrtps_cpp::_ClearPositions_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rob599_msgs2, srv, ClearPositions_Response)() {
  return &rob599_msgs2::srv::typesupport_fastrtps_cpp::_ClearPositions_Response__handle;
}
...
{
  return &rob599_msgs2::srv::typesupport_fastrtps_cpp::_ClearPositions__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rob599_msgs2, srv, ClearPositions)() {
  return &rob599_msgs2::srv::typesupport_fastrtps_cpp::_ClearPositions__handle;
}

...
#include "rob599_msgs2/srv/detail/knock_knock__rosidl_typesupport_fastrtps_c.h"
...
using _KnockKnock_Request__ros_msg_type = rob599_msgs2__srv__KnockKnock_Request;
...
size_t get_serialized_size_rob599_msgs2__srv__KnockKnock_Request(
  const void * untyped_ros_message,
...
static uint32_t _KnockKnock_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rob599_msgs2__srv__KnockKnock_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rob599_msgs2
size_t max_serialized_size_rob599_msgs2__srv__KnockKnock_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rob599_msgs2__srv__KnockKnock_Request;
    is_plain =
      (
...
static size_t _KnockKnock_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rob599_msgs2__srv__KnockKnock_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rob599_msgs2, srv, KnockKnock_Request)() {
...
using _KnockKnock_Response__ros_msg_type = rob599_msgs2__srv__KnockKnock_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rob599_msgs2
size_t get_serialized_size_rob599_msgs2__srv__KnockKnock_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _KnockKnock_Response__ros_msg_type * ros_message = static_cast<const _KnockKnock_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_rob599_msgs2__srv__KnockKnock_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rob599_msgs2
size_t max_serialized_size_rob599_msgs2__srv__KnockKnock_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = rob599_msgs2__srv__KnockKnock_Response;
    is_plain =
      (
      offsetof(DataType, structure_needs_at_least_one_member) +
      last_member_size
...
static size_t _KnockKnock_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rob599_msgs2__srv__KnockKnock_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rob599_msgs2, srv, KnockKnock_Response)() {
...
// already included above
// #include "rob599_msgs2/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "rob599_msgs2/srv/knock_knock.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rob599_msgs2, srv, KnockKnock)() {

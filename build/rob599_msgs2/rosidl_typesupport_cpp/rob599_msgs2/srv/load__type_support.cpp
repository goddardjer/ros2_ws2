...
static const _Load_Request_type_support_symbol_names_t _Load_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rob599_msgs2, srv, Load_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rob599_msgs2, srv, Load_Request)),
  }
};
...
get_message_type_support_handle<rob599_msgs2::srv::Load_Request>()
{
  return &::rob599_msgs2::srv::rosidl_typesupport_cpp::Load_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rob599_msgs2, srv, Load_Request)() {
  return get_message_type_support_handle<rob599_msgs2::srv::Load_Request>();
}
...
static const _Load_Response_type_support_symbol_names_t _Load_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rob599_msgs2, srv, Load_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rob599_msgs2, srv, Load_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<rob599_msgs2::srv::Load_Response>()
{
  return &::rob599_msgs2::srv::rosidl_typesupport_cpp::Load_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rob599_msgs2, srv, Load_Response)() {
  return get_message_type_support_handle<rob599_msgs2::srv::Load_Response>();
}
...
static const _Load_type_support_symbol_names_t _Load_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rob599_msgs2, srv, Load)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rob599_msgs2, srv, Load)),
  }
};
...
get_service_type_support_handle<rob599_msgs2::srv::Load>()
{
  return &::rob599_msgs2::srv::rosidl_typesupport_cpp::Load_service_type_support_handle;
}

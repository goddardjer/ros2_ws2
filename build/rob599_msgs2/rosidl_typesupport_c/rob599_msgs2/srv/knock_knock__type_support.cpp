...
static const _KnockKnock_Request_type_support_symbol_names_t _KnockKnock_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rob599_msgs2, srv, KnockKnock_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rob599_msgs2, srv, KnockKnock_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rob599_msgs2, srv, KnockKnock_Request)() {
  return &::rob599_msgs2::srv::rosidl_typesupport_c::KnockKnock_Request_message_type_support_handle;
}
...
static const _KnockKnock_Response_type_support_symbol_names_t _KnockKnock_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rob599_msgs2, srv, KnockKnock_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rob599_msgs2, srv, KnockKnock_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rob599_msgs2, srv, KnockKnock_Response)() {
  return &::rob599_msgs2::srv::rosidl_typesupport_c::KnockKnock_Response_message_type_support_handle;
}
...
static const _KnockKnock_type_support_symbol_names_t _KnockKnock_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rob599_msgs2, srv, KnockKnock)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rob599_msgs2, srv, KnockKnock)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, rob599_msgs2, srv, KnockKnock)() {
  return &::rob599_msgs2::srv::rosidl_typesupport_c::KnockKnock_service_type_support_handle;
}
